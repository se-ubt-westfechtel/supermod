...
/**
 * Implementation of the version space editing service specific to the revision
 * dimension. Since the revision graph is immutable, it may not be modified by
 * the user. As a consequence, a pure temporal version space is not editable.
 *
 ...
 * @date	01.08.2014
 */
public class PureRevVersionSpaceEditingService 
