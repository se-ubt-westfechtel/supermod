 ...
 * to a version space consisting of only a low-level rule base. This rule base
 * need not be mapped because low-level concepts are directly exposed to the
 * user.
 *
 ...
 * @date	28.10.2014
 */
public class PureLogVersionSpaceReconciliationService 
