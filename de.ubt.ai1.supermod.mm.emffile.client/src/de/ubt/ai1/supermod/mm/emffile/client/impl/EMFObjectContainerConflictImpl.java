...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EMF Object Container Conflict</b></em>'.
 ...
 * </p>
 * <ul>
 *   <li>{@link de.ubt.ai1.supermod.mm.emffile.client.impl.EMFObjectContainerConflictImpl#getAffectedObject <em>Affected Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EMFObjectContainerConflictImpl extends ProductConflictImpl implements EMFObjectContainerConflict {
	 ...
	 * @generated
	 */
	protected EMFObjectContainerConflictImpl() {
		super();
	}
		...
		if (affectedObject != null && affectedObject.eIsProxy()) {
			...
			if (affectedObject != oldAffectedObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SuperModEMFFileClientPackage.EMF_OBJECT_CONTAINER_CONFLICT__AFFECTED_OBJECT, oldAffectedObject, affectedObject));
			}
		}
	...
	public void setAffectedObject(EMFObject newAffectedObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SuperModEMFFileClientPackage.EMF_OBJECT_CONTAINER_CONFLICT__AFFECTED_OBJECT, oldAffectedObject, affectedObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SuperModEMFFileClientPackage.EMF_OBJECT_CONTAINER_CONFLICT__AFFECTED_OBJECT:
...
} //EMFObjectContainerConflictImpl
