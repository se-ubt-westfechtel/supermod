...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EMF Multi Feature Value Conflict</b></em>'.
 ...
 * </p>
 * <ul>
 *   <li>{@link de.ubt.ai1.supermod.mm.emffile.client.impl.EMFMultiFeatureValueConflictImpl#getAffectedFeatureRef <em>Affected Feature Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EMFMultiFeatureValueConflictImpl extends ProductConflictImpl implements EMFMultiFeatureValueConflict {
	/**
	 ...
	 * @generated
	 */
	protected EMFMultiFeatureValueConflictImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SuperModEMFFileClientPackage.Literals.EMF_MULTI_FEATURE_VALUE_CONFLICT;
	}
		...
		if (affectedFeatureRef != null && affectedFeatureRef.eIsProxy()) {
			...
			if (affectedFeatureRef != oldAffectedFeatureRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SuperModEMFFileClientPackage.EMF_MULTI_FEATURE_VALUE_CONFLICT__AFFECTED_FEATURE_REF, oldAffectedFeatureRef, affectedFeatureRef));
			}
		}
	...
	public void setAffectedFeatureRef(EMFFeatureRef newAffectedFeatureRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SuperModEMFFileClientPackage.EMF_MULTI_FEATURE_VALUE_CONFLICT__AFFECTED_FEATURE_REF, oldAffectedFeatureRef, affectedFeatureRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SuperModEMFFileClientPackage.EMF_MULTI_FEATURE_VALUE_CONFLICT__AFFECTED_FEATURE_REF:
...
} //EMFMultiFeatureValueConflictImpl
