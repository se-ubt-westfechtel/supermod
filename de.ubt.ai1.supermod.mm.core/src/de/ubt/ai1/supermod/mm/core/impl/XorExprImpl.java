 ...
 * @generated
 */
public class XorExprImpl extends BinaryExprImpl implements XorExpr {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return SuperModCorePackage.Literals.XOR_EXPR;
	}

	@Override
	public Tristate apply(OptionBinding binding) {
		return TristateUtil.xor(getLeft().apply(binding), getRight().apply(binding));
	}

	@Override
	public OptionExpr extract() {
		XorExpr extracted = SuperModCoreFactory.eINSTANCE.createXorExpr();
