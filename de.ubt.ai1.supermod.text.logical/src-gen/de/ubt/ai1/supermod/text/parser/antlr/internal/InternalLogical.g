...
entryRuleLogicalDimension returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getLogicalDimensionRule()); }
	 iv_ruleLogicalDimension=ruleLogicalDimension 
	 { $current=$iv_ruleLogicalDimension.current; } 
	 EOF 
;

// Rule LogicalDimension
ruleLogicalDimension returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleDefaultBinding returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDefaultBindingRule()); }
	 iv_ruleDefaultBinding=ruleDefaultBinding 
	 { $current=$iv_ruleDefaultBinding.current; } 
	 EOF 
;

// Rule DefaultBinding
ruleDefaultBinding returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='default' 
...
// Rule Tristate
ruleTristate returns [Enumerator current=null] 
    @init { enterRule(); }
    @after { leaveRule(); }:
