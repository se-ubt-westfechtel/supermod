...
public class SuperModListClientSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SuperModListClientPackage.ORDERING_CONFLICT: {
				OrderingConflict orderingConflict = (OrderingConflict)theEObject;
				T result = caseOrderingConflict(orderingConflict);
				if (result == null) result = caseProductConflict(orderingConflict);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ordering Conflict</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ordering Conflict</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOrderingConflict(OrderingConflict object) {
		return null;
	}
