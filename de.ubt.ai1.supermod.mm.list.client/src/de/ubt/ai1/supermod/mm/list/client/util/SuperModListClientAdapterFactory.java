...
public class SuperModListClientAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SuperModListClientSwitch<Adapter> modelSwitch =
		new SuperModListClientSwitch<Adapter>() {
			@Override
			public Adapter caseOrderingConflict(OrderingConflict object) {
				return createOrderingConflictAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.ubt.ai1.supermod.mm.list.client.OrderingConflict <em>Ordering Conflict</em>}'.
	 * <!-- begin-user-doc -->
...
} //SuperModListClientAdapterFactory
