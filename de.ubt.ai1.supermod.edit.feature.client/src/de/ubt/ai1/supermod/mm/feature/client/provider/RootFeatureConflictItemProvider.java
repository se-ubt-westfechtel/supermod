...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.feature.client.RootFeatureConflict} object.
 * <!-- begin-user-doc -->
 ...
 * @generated
 */
public class RootFeatureConflictItemProvider extends ProductConflictItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RootFeatureConflictItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RootFeatureConflict_contextModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RootFeatureConflict_contextModel_feature", "_UI_RootFeatureConflict_type"),
				 SuperModFeatureClientPackage.Literals.ROOT_FEATURE_CONFLICT__CONTEXT_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns RootFeatureConflict.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RootFeatureConflict"));
	}
	...
	public String getText(Object object) {
		Severity labelValue = ((RootFeatureConflict)object).getSeverity();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_RootFeatureConflict_type") :
			getString("_UI_RootFeatureConflict_type") + " " + label;
	}
	...
	public String getConflictDescription(ProductConflict c) {
		return "This feature model has multiple roots.";
	}
