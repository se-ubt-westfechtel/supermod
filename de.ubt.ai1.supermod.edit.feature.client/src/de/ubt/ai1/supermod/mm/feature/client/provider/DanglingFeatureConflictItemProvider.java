...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.feature.client.DanglingFeatureConflict} object.
 * <!-- begin-user-doc -->
 ...
 * @generated
 */
public class DanglingFeatureConflictItemProvider extends ProductConflictItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DanglingFeatureConflictItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DanglingFeatureConflict_contextFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DanglingFeatureConflict_contextFeature_feature", "_UI_DanglingFeatureConflict_type"),
				 SuperModFeatureClientPackage.Literals.DANGLING_FEATURE_CONFLICT__CONTEXT_FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns DanglingFeatureConflict.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DanglingFeatureConflict"));
	}
	...
	public String getText(Object object) {
		Severity labelValue = ((DanglingFeatureConflict)object).getSeverity();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_DanglingFeatureConflict_type") :
			getString("_UI_DanglingFeatureConflict_type") + " " + label;
	}
	...
	public String getConflictDescription(ProductConflict c) {
		return "The container feature of this feature is not visible in the feature model.";
	}
