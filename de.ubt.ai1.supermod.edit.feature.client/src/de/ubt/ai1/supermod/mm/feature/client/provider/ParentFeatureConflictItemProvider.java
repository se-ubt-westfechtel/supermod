...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.feature.client.ParentFeatureConflict} object.
 * <!-- begin-user-doc -->
 ...
 * @generated
 */
public class ParentFeatureConflictItemProvider extends ProductConflictItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ParentFeatureConflictItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParentFeatureConflict_contextFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParentFeatureConflict_contextFeature_feature", "_UI_ParentFeatureConflict_type"),
				 SuperModFeatureClientPackage.Literals.PARENT_FEATURE_CONFLICT__CONTEXT_FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ParentFeatureConflict.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ParentFeatureConflict"));
	}
	...
	public String getText(Object object) {
		Severity labelValue = ((ParentFeatureConflict)object).getSeverity();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ParentFeatureConflict_type") :
			getString("_UI_ParentFeatureConflict_type") + " " + label;
	}
	...
	public String getConflictDescription(ProductConflict c) {
		return "This feature has multiple parent features.";
	}
