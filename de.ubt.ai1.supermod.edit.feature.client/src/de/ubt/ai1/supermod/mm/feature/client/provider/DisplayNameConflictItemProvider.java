...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.feature.client.DisplayNameConflict} object.
 * <!-- begin-user-doc -->
 ...
 * @generated
 */
public class DisplayNameConflictItemProvider extends ProductConflictItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DisplayNameConflictItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DisplayNameConflict_contextFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DisplayNameConflict_contextFeature_feature", "_UI_DisplayNameConflict_type"),
				 SuperModFeatureClientPackage.Literals.DISPLAY_NAME_CONFLICT__CONTEXT_FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns DisplayNameConflict.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DisplayNameConflict"));
	}
	...
	public String getText(Object object) {
		Severity labelValue = ((DisplayNameConflict)object).getSeverity();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_DisplayNameConflict_type") :
			getString("_UI_DisplayNameConflict_type") + " " + label;
	}
	...
	public String getConflictDescription(ProductConflict c) {
		return "This feature has multiple names.";
	}
