...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.feature.client.FeatureConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureConfigurationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SuperModFeatureClientPackage.Literals.FEATURE_CONFIGURATION__FEATURE_MODEL,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SuperModFeatureClientPackage.Literals.FEATURE_CONFIGURATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SuperModFeatureClientPackage.Literals.FEATURE_CONFIGURATION__OPTION_BINDING);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SuperModFeatureClientPackage.Literals.FEATURE_CONFIGURATION__OPTION_BINDING,
