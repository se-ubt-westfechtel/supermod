 ...
 * specific to the change version dimension, which are hidden within
 * the package {@link de.ubt.ai1.supermod.service.change.client.impl}. Rather
 * than instantiating contained classes directly, Guice dependency injection
 * should be used with the module {@link de.ubt.ai1.supermod.service.change
 * .client.SuperModChangeClientModule}.
 * 
