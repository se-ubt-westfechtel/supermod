...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.feature.RootRelationship} object.
 * <!-- begin-user-doc -->
 ...
 * @generated
 */
public class RootRelationshipItemProvider extends HybridElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RootRelationshipItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns RootRelationship.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public String getText(Object object) {
		String label = ((RootRelationship)object).getProxyUUID();
		return label == null || label.length() == 0 ?
			getString("_UI_RootRelationship_type") :
			getString("_UI_RootRelationship_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RootRelationship.class)) {
