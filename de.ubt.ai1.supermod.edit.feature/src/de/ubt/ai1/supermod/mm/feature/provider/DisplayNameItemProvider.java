...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.feature.DisplayName} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DisplayNameItemProvider extends HybridElementItemProvider {
	/**
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DisplayName"));
	}
	...
	public String getText(Object object) {
		String label = ((DisplayName)object).getDisplayName();
		return label == null || label.length() == 0 ?
			getString("_UI_DisplayName_type") :
			getString("_UI_DisplayName_type") + " " + label;
	}
