...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.feature.Elimination} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EliminationItemProvider extends HybridElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EliminationItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Elimination"));
	}
	...
	public String getText(Object object) {
		String label = ((Elimination)object).getProxyUUID();
		return label == null || label.length() == 0 ?
			getString("_UI_Elimination_type") :
			getString("_UI_Elimination_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Elimination.class)) {
