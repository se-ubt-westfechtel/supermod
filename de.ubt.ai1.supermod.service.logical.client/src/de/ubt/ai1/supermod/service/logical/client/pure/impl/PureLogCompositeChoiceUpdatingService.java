...
/**
 * An implementation of the composite choice updating service. Since the logical
 ...
 * @date	01.08.2014
 */
public class PureLogCompositeChoiceUpdatingService 
implements ICompositeChoiceUpdatingService {

	/* (non-Javadoc)
	 * @see de.ubt.ai1.supermod.service.client.
	 * ICompositeChoiceUpdatingService#updateCompositeChoice(
