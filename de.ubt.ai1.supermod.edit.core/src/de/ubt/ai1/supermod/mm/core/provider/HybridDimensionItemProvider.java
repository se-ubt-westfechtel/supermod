...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.core.HybridDimension} object.
 * <!-- begin-user-doc -->
...
public class HybridDimensionItemProvider extends VersionDimensionItemProvider {
	...
	public String getText(Object object) {
		String label = ((HybridDimension)object).getDimensionName();
		return label == null || label.length() == 0 ?
			getString("_UI_HybridDimension_type") :
			getString("_UI_HybridDimension_type") + " " + label;
	}
