...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.core.Preference} object.
 * <!-- begin-user-doc -->
...
public class PreferenceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Preference_option_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Preference_option_feature", "_UI_Preference_type"),
				 SuperModCorePackage.Literals.PREFERENCE__OPTION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SuperModCorePackage.Literals.PREFERENCE__OPTION_EXPR);
		}
	...
	public String getText(Object object) {
		String label = ((Preference)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SuperModCorePackage.Literals.PREFERENCE__OPTION_EXPR,
