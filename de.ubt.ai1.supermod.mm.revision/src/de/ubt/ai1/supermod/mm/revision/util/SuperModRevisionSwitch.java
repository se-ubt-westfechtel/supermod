 ...
 * @generated
 */
public class SuperModRevisionSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SuperModRevisionPackage.REVISION_DIMENSION: {
				RevisionDimension revisionDimension = (RevisionDimension)theEObject;
				T result = caseRevisionDimension(revisionDimension);
				if (result == null) result = caseVersionDimension(revisionDimension);
				if (result == null) result = caseDimension(revisionDimension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SuperModRevisionPackage.REVISION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Revision Dimension</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Revision Dimension</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRevisionDimension(RevisionDimension object) {
		return null;
	}
