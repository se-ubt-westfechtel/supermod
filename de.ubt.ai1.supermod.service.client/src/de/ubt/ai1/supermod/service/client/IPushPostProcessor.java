...
/**
 * Client service interface to manage the local repository after having pushed
 ...
 * @date	10.11.2015
 */
public interface IPushPostProcessor {
	
	/**
	 * To be implemented in order to perform the necessary post processing
	 * steps after the repository has been pushed
	 *
	 * @param repo the local copy of the pushed repository
