...
/**
 * An implementation of the share post processor client service interface
 ...
 * @date	10.11.2015
 */
public class GenericIdleSharePostProcessor 
implements ISharePostProcessor {

	/* (non-Javadoc)
	 * @see de.ubt.ai1.supermod.service.client.ISharePostProcessor
