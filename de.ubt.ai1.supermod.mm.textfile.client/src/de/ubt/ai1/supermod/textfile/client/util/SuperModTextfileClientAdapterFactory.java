...
public class SuperModTextfileClientAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SuperModTextfileClientSwitch<Adapter> modelSwitch =
		new SuperModTextfileClientSwitch<Adapter>() {
			@Override
			public Adapter caseTextFileExportTrace(TextFileExportTrace object) {
				return createTextFileExportTraceAdapter();
			}
			@Override
			public Adapter caseTextLineExportTrace(TextLineExportTrace object) {
				return createTextLineExportTraceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.ubt.ai1.supermod.textfile.client.TextFileExportTrace <em>Text File Export Trace</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.ubt.ai1.supermod.textfile.client.TextLineExportTrace <em>Text Line Export Trace</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //SuperModTextfileClientAdapterFactory
