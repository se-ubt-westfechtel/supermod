...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Non Optional Grouped Feature Conflict</b></em>'.
 ...
 * </p>
 * <ul>
 *   <li>{@link de.ubt.ai1.supermod.mm.feature.client.impl.NonOptionalGroupedFeatureConflictImpl#getContextFeature <em>Context Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NonOptionalGroupedFeatureConflictImpl extends ProductConflictImpl implements NonOptionalGroupedFeatureConflict {
	/**
	 ...
	 * @generated
	 */
	protected NonOptionalGroupedFeatureConflictImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SuperModFeatureClientPackage.Literals.NON_OPTIONAL_GROUPED_FEATURE_CONFLICT;
	}
		...
		if (contextFeature != null && contextFeature.eIsProxy()) {
			...
			if (contextFeature != oldContextFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SuperModFeatureClientPackage.NON_OPTIONAL_GROUPED_FEATURE_CONFLICT__CONTEXT_FEATURE, oldContextFeature, contextFeature));
			}
		}
	...
	public void setContextFeature(Feature newContextFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SuperModFeatureClientPackage.NON_OPTIONAL_GROUPED_FEATURE_CONFLICT__CONTEXT_FEATURE, oldContextFeature, contextFeature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SuperModFeatureClientPackage.NON_OPTIONAL_GROUPED_FEATURE_CONFLICT__CONTEXT_FEATURE:
...
} //NonOptionalGroupedFeatureConflictImpl
