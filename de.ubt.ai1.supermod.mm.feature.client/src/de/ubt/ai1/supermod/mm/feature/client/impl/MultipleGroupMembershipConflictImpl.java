...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Multiple Group Membership Conflict</b></em>'.
 ...
 * </p>
 * <ul>
 *   <li>{@link de.ubt.ai1.supermod.mm.feature.client.impl.MultipleGroupMembershipConflictImpl#getContextFeature <em>Context Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultipleGroupMembershipConflictImpl extends ProductConflictImpl implements MultipleGroupMembershipConflict {
	/**
	 ...
	 * @generated
	 */
	protected MultipleGroupMembershipConflictImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SuperModFeatureClientPackage.Literals.MULTIPLE_GROUP_MEMBERSHIP_CONFLICT;
	}
		...
		if (contextFeature != null && contextFeature.eIsProxy()) {
			...
			if (contextFeature != oldContextFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SuperModFeatureClientPackage.MULTIPLE_GROUP_MEMBERSHIP_CONFLICT__CONTEXT_FEATURE, oldContextFeature, contextFeature));
			}
		}
	...
	public void setContextFeature(Feature newContextFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SuperModFeatureClientPackage.MULTIPLE_GROUP_MEMBERSHIP_CONFLICT__CONTEXT_FEATURE, oldContextFeature, contextFeature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SuperModFeatureClientPackage.MULTIPLE_GROUP_MEMBERSHIP_CONFLICT__CONTEXT_FEATURE:
...
} //MultipleGroupMembershipConflictImpl
