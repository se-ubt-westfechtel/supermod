...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Parent Feature Conflict</b></em>'.
 ...
 * </p>
 * <ul>
 *   <li>{@link de.ubt.ai1.supermod.mm.feature.client.impl.ParentFeatureConflictImpl#getContextFeature <em>Context Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParentFeatureConflictImpl extends ProductConflictImpl implements ParentFeatureConflict {
	 ...
	 * @generated
	 */
	protected ParentFeatureConflictImpl() {
		super();
	}
		...
		if (contextFeature != null && contextFeature.eIsProxy()) {
			...
			if (contextFeature != oldContextFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SuperModFeatureClientPackage.PARENT_FEATURE_CONFLICT__CONTEXT_FEATURE, oldContextFeature, contextFeature));
			}
		}
	...
	public void setContextFeature(Feature newContextFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SuperModFeatureClientPackage.PARENT_FEATURE_CONFLICT__CONTEXT_FEATURE, oldContextFeature, contextFeature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SuperModFeatureClientPackage.PARENT_FEATURE_CONFLICT__CONTEXT_FEATURE:
