...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dangling Feature Conflict</b></em>'.
 ...
 * </p>
 * <ul>
 *   <li>{@link de.ubt.ai1.supermod.mm.feature.client.impl.DanglingFeatureConflictImpl#getContextFeature <em>Context Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DanglingFeatureConflictImpl extends ProductConflictImpl implements DanglingFeatureConflict {
	/**
	 ...
	 * @generated
	 */
	protected DanglingFeatureConflictImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SuperModFeatureClientPackage.Literals.DANGLING_FEATURE_CONFLICT;
	}
		...
		if (contextFeature != null && contextFeature.eIsProxy()) {
			...
			if (contextFeature != oldContextFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SuperModFeatureClientPackage.DANGLING_FEATURE_CONFLICT__CONTEXT_FEATURE, oldContextFeature, contextFeature));
			}
		}
	...
	public void setContextFeature(Feature newContextFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SuperModFeatureClientPackage.DANGLING_FEATURE_CONFLICT__CONTEXT_FEATURE, oldContextFeature, contextFeature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SuperModFeatureClientPackage.DANGLING_FEATURE_CONFLICT__CONTEXT_FEATURE:
