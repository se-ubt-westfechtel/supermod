...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dependency Link Target Conflict</b></em>'.
 ...
 * </p>
 * <ul>
 *   <li>{@link de.ubt.ai1.supermod.mm.feature.client.impl.DependencyLinkTargetConflictImpl#getContextDependency <em>Context Dependency</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependencyLinkTargetConflictImpl extends ProductConflictImpl implements DependencyLinkTargetConflict {
	/**
	 ...
	 * @generated
	 */
	protected DependencyLinkTargetConflictImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SuperModFeatureClientPackage.Literals.DEPENDENCY_LINK_TARGET_CONFLICT;
	}
		...
		if (contextDependency != null && contextDependency.eIsProxy()) {
			...
			if (contextDependency != oldContextDependency) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SuperModFeatureClientPackage.DEPENDENCY_LINK_TARGET_CONFLICT__CONTEXT_DEPENDENCY, oldContextDependency, contextDependency));
			}
		}
	...
	public void setContextDependency(FeatureDependency newContextDependency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SuperModFeatureClientPackage.DEPENDENCY_LINK_TARGET_CONFLICT__CONTEXT_DEPENDENCY, oldContextDependency, contextDependency));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SuperModFeatureClientPackage.DEPENDENCY_LINK_TARGET_CONFLICT__CONTEXT_DEPENDENCY:
...
} //DependencyLinkTargetConflictImpl
