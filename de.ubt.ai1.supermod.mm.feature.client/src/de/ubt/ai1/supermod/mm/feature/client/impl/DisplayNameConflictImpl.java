...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Display Name Conflict</b></em>'.
 ...
 * </p>
 * <ul>
 *   <li>{@link de.ubt.ai1.supermod.mm.feature.client.impl.DisplayNameConflictImpl#getContextFeature <em>Context Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DisplayNameConflictImpl extends ProductConflictImpl implements DisplayNameConflict {
	/**
	 ...
	 * @generated
	 */
	protected DisplayNameConflictImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SuperModFeatureClientPackage.Literals.DISPLAY_NAME_CONFLICT;
	}
		...
		if (contextFeature != null && contextFeature.eIsProxy()) {
			...
			if (contextFeature != oldContextFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SuperModFeatureClientPackage.DISPLAY_NAME_CONFLICT__CONTEXT_FEATURE, oldContextFeature, contextFeature));
			}
		}
	...
	public void setContextFeature(Feature newContextFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SuperModFeatureClientPackage.DISPLAY_NAME_CONFLICT__CONTEXT_FEATURE, oldContextFeature, contextFeature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SuperModFeatureClientPackage.DISPLAY_NAME_CONFLICT__CONTEXT_FEATURE:
