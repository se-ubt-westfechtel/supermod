 ...
 * as its product space, and a low-level logical version space.
 *
 ...
 * @date	09.12.2014
 */
public class HetfilePurelogClientModuleInjectorProvider 
	...
	public Injector getModuleInjector() {
		return Guice.createInjector(
				...
				.with(
					...
					new SuperModPureLogClientModule()),
				new AbstractModule() {					
					@Override
	...
	public Image getImage() {
		try {
			return new Image(null, 
					new URL("platform:/plugin/de.ubt.ai1.supermod.module.hetfile.purelog.client/icons/hetfile-purelog.png")
					.openStream());
