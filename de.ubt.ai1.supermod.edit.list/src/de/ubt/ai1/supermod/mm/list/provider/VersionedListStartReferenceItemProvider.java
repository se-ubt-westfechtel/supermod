...
/**
 * This is the item provider adapter for a {@link de.ubt.ai1.supermod.mm.list.VersionedListStartReference} object.
 * <!-- begin-user-doc -->
...
public class VersionedListStartReferenceItemProvider extends ProductSpaceElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VersionedListStartReference_vertex_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VersionedListStartReference_vertex_feature", "_UI_VersionedListStartReference_type"),
				 SuperModListPackage.Literals.VERSIONED_LIST_START_REFERENCE__VERTEX,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns VersionedListStartReference.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VersionedListStartReference"));
	}
	...
	public String getText(Object object) {
		String label = ((VersionedListStartReference)object).getProxyUUID();
		return label == null || label.length() == 0 ?
			getString("_UI_VersionedListStartReference_type") :
			getString("_UI_VersionedListStartReference_type") + " " + label;
	}
