 ...
 *****************************************************************************/
package de.ubt.ai1.supermod.module.hetfile.purerev.client;
...
import de.ubt.ai1.supermod.service.revision.client.pure.SuperModPureRevClientModule;
import de.ubt.ai1.supermod.service.revision.pure.SuperModPureRevModule;
 ...
 * as its product space, and a revision graph as version space.
 *
 ...
 * @date	09.12.2014
 */
public class HetfilePurerevClientModuleInjectorProvider 
implements ISuperModClientModuleInjectorProvider {
	...
	public String getModuleId() {
		return "de.ubt.ai1.supermod.hetfile.purerev";
	}
	...
	public Injector getModuleInjector() {
		return Guice.createInjector(
				...
				.with(
					...
					new SuperModPureRevClientModule()),
				new AbstractModule() {					
					@Override
	...
	public String getDescription() {
		return "A heterogeneous file system (EMF, text, XML) versioned by a local revision graph";
	}
	...
	public Image getImage() {
		try {
			return new Image(null, 
					new URL("platform:/plugin/de.ubt.ai1.supermod.module.hetfile.purerev.client/icons/hetfile-purerev.png")
					.openStream());
