...
/**
 * Implementation of the ambition correction service specific to the rev-feat
 ...
 * @date	29.09.2015
 */
public class RevFeatAmbitionCorrectionService
implements IAmbitionCorrectionService {
	...
	public OptionBinding specifyCorrectingAmbition(LocalRepository repo, 
		...
		// a fake product space is necessary for the match operation invoked
		// by the merge service.
		localFm.setProductSpace(SuperModCoreFactory.eINSTANCE.createProductSpace());
		featDimMergeService.merge(repoFm, localFm, null);
		localFm.setProductSpace(null);
