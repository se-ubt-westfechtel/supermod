...
/**
 * Custom default resolution provider for the revfeat dimension.
 * <p>
 * Supported strategies: '<em>Random</em>', '<em>Most Recent</em>', '<em>Least
 * Recent</em>', '<em>Most Specific</em>', '<em>Least Specific</em>'
 * 
 ...
 * @date	2018-01-09
 */
public class RevFeatDefaultResolver extends RevisionDefaultResolver {
