...
public class SuperModLogicalSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SuperModLogicalPackage.LOGICAL_DIMENSION: {
				LogicalDimension logicalDimension = (LogicalDimension)theEObject;
				T result = caseLogicalDimension(logicalDimension);
				if (result == null) result = caseVersionDimension(logicalDimension);
				if (result == null) result = caseDimension(logicalDimension);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Logical Dimension</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Logical Dimension</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLogicalDimension(LogicalDimension object) {
		return null;
	}
