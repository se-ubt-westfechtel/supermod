...
public class SuperModLogicalAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SuperModLogicalSwitch<Adapter> modelSwitch =
		new SuperModLogicalSwitch<Adapter>() {
			@Override
			public Adapter caseLogicalDimension(LogicalDimension object) {
				return createLogicalDimensionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.ubt.ai1.supermod.mm.logical.LogicalDimension <em>Logical Dimension</em>}'.
	 * <!-- begin-user-doc -->
