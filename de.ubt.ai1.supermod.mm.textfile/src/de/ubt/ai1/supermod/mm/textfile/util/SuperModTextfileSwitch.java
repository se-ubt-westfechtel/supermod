...
public class SuperModTextfileSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SuperModTextfilePackage.TEXT_FILE_CONTENT: {
				TextFileContent textFileContent = (TextFileContent)theEObject;
				T result = caseTextFileContent(textFileContent);
				if (result == null) result = caseVersionedFileContent(textFileContent);
				if (result == null) result = caseProductSpaceElement(textFileContent);
				if (result == null) result = caseElement(textFileContent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SuperModTextfilePackage.TEXT_LINE: {
				TextLine textLine = (TextLine)theEObject;
				T result = caseTextLine(textLine);
				if (result == null) result = caseProductSpaceElement(textLine);
				if (result == null) result = caseElement(textLine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Text File Content</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Text File Content</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTextFileContent(TextFileContent object) {
		return null;
	}
