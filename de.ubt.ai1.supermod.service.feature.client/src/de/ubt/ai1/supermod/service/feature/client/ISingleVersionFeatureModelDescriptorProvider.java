...
/**
 * Provider interface for a single-version feature model dimension descriptor
...
public interface ISingleVersionFeatureModelDescriptorProvider {
	...
	/**
	 * To be implemented in order to return the feature model descriptor.
	 *
	 * @param desc where to find the feature model descriptor in.
